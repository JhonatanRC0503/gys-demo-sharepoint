...
class FileStrategy(Strategy):
    ...
    def setup_search_manager(self):
        self.search_manager = SearchManager(
            ...
            search_images=self.figure_processor is not None,  # Include images field when figures are processed
...
class UploadUserFileStrategy:
    ...
    def __init__(
        ...
        self.search_manager = SearchManager(
            ...
            search_images=figure_processor is not None,  # Include images field when figures are processed
