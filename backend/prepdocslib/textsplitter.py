...
DEFAULT_OVERLAP_PERCENT = 20  # See semantic search article for 20% overlap performance
DEFAULT_SECTION_LENGTH = 4000 # aproximadamente 3200 tokens
...
class SentenceTextSplitter(TextSplitter):
    ...
    def __init__(self, max_tokens_per_section: int = 3500):
